<template>
  <div style="overflow-y: auto;height: 600px;background-color: white !important;padding: 50px; padding-bottom: 10px;" class="container">
    ...
    <div v-if="!changingDetails" class="row">
      <div id="carouselExampleControls" class="carousel slide col-5" data-ride="carousel" style="height: 50%; width: 50%;">
      ...
      <google-map :location="apartmentDetails.location" class="col-5" style="width: 80%" />
    </div>
...
import GoogleMap from "@/components/SharedComponents/GoogleMap";
